...
The concentration values within this windows is averaged out for every data point.  Then, this scalar is saved into same row as the initial data point, but into a separate column called "chemical name"_moving_avg specific to an individual chemical.  
...
chem_site_plot <- long_sites_avg %>% 
  ...
  scale_color_manual(values=c("purple", "darkblue", "blue", "yellow")) +
